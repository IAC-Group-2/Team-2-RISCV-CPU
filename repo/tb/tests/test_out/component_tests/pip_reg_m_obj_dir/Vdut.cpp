...
Vdut::Vdut(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , RegWriteE_i{vlSymsp->TOP.RegWriteE_i}
    , RegWriteM_o{vlSymsp->TOP.RegWriteM_o}
    , ResultSrcE_i{vlSymsp->TOP.ResultSrcE_i}
    , ResultSrcM_o{vlSymsp->TOP.ResultSrcM_o}
    , MemWriteE_i{vlSymsp->TOP.MemWriteE_i}
    , MemWriteM_o{vlSymsp->TOP.MemWriteM_o}
    , funct3E_i{vlSymsp->TOP.funct3E_i}
    , funct3M_o{vlSymsp->TOP.funct3M_o}
    , RdE_i{vlSymsp->TOP.RdE_i}
    , RdM_o{vlSymsp->TOP.RdM_o}
    , ALUResultE_i{vlSymsp->TOP.ALUResultE_i}
    , ALUResultM_o{vlSymsp->TOP.ALUResultM_o}
    , WriteDataE_i{vlSymsp->TOP.WriteDataE_i}
    , WriteDataM_o{vlSymsp->TOP.WriteDataM_o}
    , PCPlus4E_i{vlSymsp->TOP.PCPlus4E_i}
    , PCPlus4M_o{vlSymsp->TOP.PCPlus4M_o}
    , rootp{&(vlSymsp->TOP)}
{
