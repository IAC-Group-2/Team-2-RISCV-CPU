...
VL_ATTR_COLD void Vdut___024root__trace_init_sub__TOP__0(Vdut___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    // Body
    tracep->declBus(c+1,"funct3_i", false,-1, 2,0);
    tracep->declBit(c+2,"Zero_i", false,-1);
    tracep->declBus(c+3,"SrcA_i", false,-1, 31,0);
    tracep->declBus(c+4,"SrcB_i", false,-1, 31,0);
    tracep->declBit(c+5,"BranchTaken_o", false,-1);
    tracep->pushNamePrefix("branch_unit ");
...
VL_ATTR_COLD void Vdut___024root__trace_full_sub_0(Vdut___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullCData(oldp+1,(vlSelf->funct3_i),3);
    bufp->fullBit(oldp+2,(vlSelf->Zero_i));
    bufp->fullIData(oldp+3,(vlSelf->SrcA_i),32);
    bufp->fullIData(oldp+4,(vlSelf->SrcB_i),32);
    bufp->fullBit(oldp+5,(vlSelf->BranchTaken_o));
