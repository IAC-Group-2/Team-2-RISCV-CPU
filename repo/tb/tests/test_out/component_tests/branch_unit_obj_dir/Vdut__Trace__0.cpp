...
void Vdut___024root__trace_chg_sub_0(Vdut___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->chgCData(oldp+0,(vlSelf->funct3_i),3);
    bufp->chgBit(oldp+1,(vlSelf->Zero_i));
    bufp->chgIData(oldp+2,(vlSelf->SrcA_i),32);
    bufp->chgIData(oldp+3,(vlSelf->SrcB_i),32);
    bufp->chgBit(oldp+4,(vlSelf->BranchTaken_o));
}
