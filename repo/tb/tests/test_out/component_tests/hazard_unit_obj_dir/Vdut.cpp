...
Vdut::Vdut(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , Rs1E_i{vlSymsp->TOP.Rs1E_i}
    , Rs2E_i{vlSymsp->TOP.Rs2E_i}
    , RdE_i{vlSymsp->TOP.RdE_i}
    , ResultSrcE0_i{vlSymsp->TOP.ResultSrcE0_i}
    , RdM_i{vlSymsp->TOP.RdM_i}
    , RegWriteM_i{vlSymsp->TOP.RegWriteM_i}
    , RdW_i{vlSymsp->TOP.RdW_i}
    , RegWriteW_i{vlSymsp->TOP.RegWriteW_i}
    , PCSrcE_i{vlSymsp->TOP.PCSrcE_i}
    , CacheStall_i{vlSymsp->TOP.CacheStall_i}
    , ForwardAE_o{vlSymsp->TOP.ForwardAE_o}
    , ForwardBE_o{vlSymsp->TOP.ForwardBE_o}
    , StallF_o{vlSymsp->TOP.StallF_o}
    , StallD_o{vlSymsp->TOP.StallD_o}
    , StallE_o{vlSymsp->TOP.StallE_o}
    , StallM_o{vlSymsp->TOP.StallM_o}
    , StallW_o{vlSymsp->TOP.StallW_o}
    , FlushD_o{vlSymsp->TOP.FlushD_o}
    , FlushE_o{vlSymsp->TOP.FlushE_o}
    , rootp{&(vlSymsp->TOP)}
{
