...
Vdut::Vdut(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , predictTakenF_o{vlSymsp->TOP.predictTakenF_o}
    , BranchE_i{vlSymsp->TOP.BranchE_i}
    , TakenE_i{vlSymsp->TOP.TakenE_i}
    , PCF_i{vlSymsp->TOP.PCF_i}
    , PCE_i{vlSymsp->TOP.PCE_i}
    , predictTargetF_o{vlSymsp->TOP.predictTargetF_o}
