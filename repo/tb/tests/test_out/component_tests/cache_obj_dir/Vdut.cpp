...
Vdut::Vdut(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , MemWriteM_i{vlSymsp->TOP.MemWriteM_i}
    , ResultSrcM_i{vlSymsp->TOP.ResultSrcM_i}
    , funct3_i{vlSymsp->TOP.funct3_i}
    , mem_wr_en_o{vlSymsp->TOP.mem_wr_en_o}
    , funct3_o{vlSymsp->TOP.funct3_o}
    , cache_miss_o{vlSymsp->TOP.cache_miss_o}
    , stall_o{vlSymsp->TOP.stall_o}
    , addr_i{vlSymsp->TOP.addr_i}
    , data_i{vlSymsp->TOP.data_i}
    , mem_rd_data_i{vlSymsp->TOP.mem_rd_data_i}
    , mem_addr_o{vlSymsp->TOP.mem_addr_o}
    , mem_wr_data_o{vlSymsp->TOP.mem_wr_data_o}
