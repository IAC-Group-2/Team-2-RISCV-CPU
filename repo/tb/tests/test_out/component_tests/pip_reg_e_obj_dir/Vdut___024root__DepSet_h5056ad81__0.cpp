...
VL_INLINE_OPT void Vdut___024root___sequent__TOP__0(Vdut___024root* vlSelf) {
    ...
    if (vlSelf->clr_i) {
        ...
        vlSelf->predictTakenE_o = vlSelf->predictTakenD_i;
        ...
        vlSelf->ALUSrcAE_o = vlSelf->ALUSrcAD_i;
...
void Vdut___024root___eval_debug_assertions(Vdut___024root* vlSelf) {
    ...
    if (VL_UNLIKELY((vlSelf->predictTakenD_i & 0xfeU))) {
        Verilated::overWidthError("predictTakenD_i");}
}
#endif  // VL_DEBUG
