...
Vdut::Vdut(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , predictTakenD_o{vlSymsp->TOP.predictTakenD_o}
    , PCF_i{vlSymsp->TOP.PCF_i}
    , PCD_o{vlSymsp->TOP.PCD_o}
    , InstrF_i{vlSymsp->TOP.InstrF_i}
    , InstrD_o{vlSymsp->TOP.InstrD_o}
    , PCPlus4F_i{vlSymsp->TOP.PCPlus4F_i}
    , PCPlus4D_o{vlSymsp->TOP.PCPlus4D_o}
    , rootp{&(vlSymsp->TOP)}
{
