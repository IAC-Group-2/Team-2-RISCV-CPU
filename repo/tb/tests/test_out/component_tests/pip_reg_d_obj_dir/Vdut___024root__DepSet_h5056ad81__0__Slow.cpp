...
VL_ATTR_COLD void Vdut___024root___ctor_var_reset(Vdut___024root* vlSelf) {
    ...
    vlSelf->PCD_o = VL_RAND_RESET_I(32);
    vlSelf->InstrF_i = VL_RAND_RESET_I(32);
    vlSelf->InstrD_o = VL_RAND_RESET_I(32);
    vlSelf->PCPlus4F_i = VL_RAND_RESET_I(32);
    vlSelf->PCPlus4D_o = VL_RAND_RESET_I(32);
    vlSelf->predictTakenF_i = VL_RAND_RESET_I(1);
    vlSelf->predictTakenD_o = VL_RAND_RESET_I(1);
}
