...
void Vdut___024root__trace_chg_sub_0(Vdut___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgBit(oldp+2,(vlSelf->clr_i));
    bufp->chgIData(oldp+3,(vlSelf->PCF_i),32);
    bufp->chgIData(oldp+4,(vlSelf->PCD_o),32);
    bufp->chgIData(oldp+5,(vlSelf->InstrF_i),32);
    bufp->chgIData(oldp+6,(vlSelf->InstrD_o),32);
    bufp->chgIData(oldp+7,(vlSelf->PCPlus4F_i),32);
    bufp->chgIData(oldp+8,(vlSelf->PCPlus4D_o),32);
    bufp->chgBit(oldp+9,(vlSelf->predictTakenF_i));
    bufp->chgBit(oldp+10,(vlSelf->predictTakenD_o));
}
