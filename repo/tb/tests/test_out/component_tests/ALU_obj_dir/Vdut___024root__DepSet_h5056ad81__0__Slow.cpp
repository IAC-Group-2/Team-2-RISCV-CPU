...
VL_ATTR_COLD void Vdut___024root___ctor_var_reset(Vdut___024root* vlSelf) {
    ...
    // Body
    vlSelf->SrcA_i = VL_RAND_RESET_I(32);
    vlSelf->SrcB_i = VL_RAND_RESET_I(32);
    vlSelf->ALUControl_i = VL_RAND_RESET_I(4);
    vlSelf->ALUResult_o = VL_RAND_RESET_I(32);
    vlSelf->Zero_o = VL_RAND_RESET_I(1);
    vlSelf->ALU__DOT__signed_product = VL_RAND_RESET_Q(64);
}
