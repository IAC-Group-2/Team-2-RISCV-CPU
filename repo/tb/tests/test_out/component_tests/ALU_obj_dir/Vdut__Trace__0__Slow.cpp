...
VL_ATTR_COLD void Vdut___024root__trace_init_sub__TOP__0(Vdut___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+3,"ALUControl_i", false,-1, 3,0);
    tracep->declBus(c+4,"ALUResult_o", false,-1, 31,0);
    tracep->declBit(c+5,"Zero_o", false,-1);
    ...
    tracep->declBus(c+4,"ALUResult_o", false,-1, 31,0);
    tracep->declBit(c+5,"Zero_o", false,-1);
    tracep->declQuad(c+6,"signed_product", false,-1, 63,0);
    tracep->declQuad(c+8,"unsigned_product", false,-1, 63,0);
    tracep->declQuad(c+8,"signed_unsigned_product", false,-1, 63,0);
...
VL_ATTR_COLD void Vdut___024root__trace_full_sub_0(Vdut___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+3,(vlSelf->ALUControl_i),4);
    bufp->fullIData(oldp+4,(vlSelf->ALUResult_o),32);
    bufp->fullBit(oldp+5,(vlSelf->Zero_o));
    bufp->fullQData(oldp+6,(vlSelf->ALU__DOT__signed_product),64);
    bufp->fullQData(oldp+8,(((QData)((IData)(vlSelf->SrcA_i)) 
                             * (QData)((IData)(vlSelf->SrcB_i)))),64);
