...
void Vdut___024root__trace_chg_sub_0(Vdut___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->chgIData(oldp+0,(vlSelf->in0_i),32);
    bufp->chgIData(oldp+1,(vlSelf->in1_i),32);
    bufp->chgIData(oldp+2,(vlSelf->in2_i),32);
    bufp->chgCData(oldp+3,(vlSelf->sel_i),2);
    bufp->chgIData(oldp+4,(vlSelf->out_o),32);
}
