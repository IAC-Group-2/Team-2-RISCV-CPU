...
Vdut::Vdut(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , RegWriteW_o{vlSymsp->TOP.RegWriteW_o}
    , ResultSrcM_i{vlSymsp->TOP.ResultSrcM_i}
    , ResultSrcW_o{vlSymsp->TOP.ResultSrcW_o}
    , RdM_i{vlSymsp->TOP.RdM_i}
    , RdW_o{vlSymsp->TOP.RdW_o}
    , ALUResultM_i{vlSymsp->TOP.ALUResultM_i}
    , ALUResultW_o{vlSymsp->TOP.ALUResultW_o}
    , ReadDataM_i{vlSymsp->TOP.ReadDataM_i}
    , ReadDataW_o{vlSymsp->TOP.ReadDataW_o}
    , PCPlus4M_i{vlSymsp->TOP.PCPlus4M_i}
    , PCPlus4W_o{vlSymsp->TOP.PCPlus4W_o}
    , rootp{&(vlSymsp->TOP)}
{
