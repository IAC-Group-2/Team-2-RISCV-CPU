...
void Vdut___024root__trace_chg_sub_0(Vdut___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgBit(oldp+1,(vlSelf->wr_en_i));
    bufp->chgCData(oldp+2,(vlSelf->funct3_i),3);
    bufp->chgIData(oldp+3,(vlSelf->addr_i),32);
    bufp->chgIData(oldp+4,(vlSelf->data_i),32);
    bufp->chgIData(oldp+5,(vlSelf->data_o),32);
    bufp->chgIData(oldp+6,((0x1ffffU & vlSelf->addr_i)),17);
}
