...
Vdut::Vdut(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , PredictTakenF_i{vlSymsp->TOP.PredictTakenF_i}
    , MispredictE_i{vlSymsp->TOP.MispredictE_i}
    , PCSrcE_i{vlSymsp->TOP.PCSrcE_i}
    , JalrE_i{vlSymsp->TOP.JalrE_i}
    , PCPlus4F_i{vlSymsp->TOP.PCPlus4F_i}
    , PredictTargetF_i{vlSymsp->TOP.PredictTargetF_i}
    , PCTargetE_i{vlSymsp->TOP.PCTargetE_i}
    , ALUResultE_i{vlSymsp->TOP.ALUResultE_i}
    , PCPlus4E_i{vlSymsp->TOP.PCPlus4E_i}
    , PCNext_o{vlSymsp->TOP.PCNext_o}
    , rootp{&(vlSymsp->TOP)}
{
