...
VL_ATTR_COLD void Vdut___024root__trace_init_sub__TOP__0(Vdut___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+2,"PredictTargetF_i", false,-1, 31,0);
    tracep->declBit(c+3,"PredictTakenF_i", false,-1);
    tracep->declBit(c+4,"MispredictE_i", false,-1);
    tracep->declBus(c+5,"PCTargetE_i", false,-1, 31,0);
    tracep->declBus(c+6,"ALUResultE_i", false,-1, 31,0);
    tracep->declBus(c+7,"PCPlus4E_i", false,-1, 31,0);
    tracep->declBit(c+8,"PCSrcE_i", false,-1);
    tracep->declBit(c+9,"JalrE_i", false,-1);
    tracep->declBus(c+10,"PCNext_o", false,-1, 31,0);
    ...
    tracep->declBit(c+9,"JalrE_i", false,-1);
    tracep->declBus(c+10,"PCNext_o", false,-1, 31,0);
    tracep->declBus(c+11,"ActualTargetE", false,-1, 31,0);
...
VL_ATTR_COLD void Vdut___024root__trace_full_sub_0(Vdut___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+2,(vlSelf->PredictTargetF_i),32);
    bufp->fullBit(oldp+3,(vlSelf->PredictTakenF_i));
    bufp->fullBit(oldp+4,(vlSelf->MispredictE_i));
    bufp->fullIData(oldp+5,(vlSelf->PCTargetE_i),32);
    bufp->fullIData(oldp+6,(vlSelf->ALUResultE_i),32);
    bufp->fullIData(oldp+7,(vlSelf->PCPlus4E_i),32);
    bufp->fullBit(oldp+8,(vlSelf->PCSrcE_i));
    bufp->fullBit(oldp+9,(vlSelf->JalrE_i));
    bufp->fullIData(oldp+10,(vlSelf->PCNext_o),32);
    bufp->fullIData(oldp+11,(vlSelf->mux_reg__DOT__ActualTargetE),32);
