...
void Vdut___024root__trace_chg_sub_0(Vdut___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->chgIData(oldp+1,(vlSelf->PCTargetE_i),32);
    bufp->chgIData(oldp+2,(vlSelf->ALUResultE_i),32);
    bufp->chgBit(oldp+3,(vlSelf->PCSrcE_i));
    bufp->chgBit(oldp+4,(vlSelf->JalrE_i));
    bufp->chgIData(oldp+5,(vlSelf->PCNext_o),32);
}
